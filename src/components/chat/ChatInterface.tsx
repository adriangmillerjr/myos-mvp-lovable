        ...
        <div className="space-y-4 max-w-4xl mx-auto">
          {messages.length === 0 ? (
            <div className="text-center py-12">
              <div className="bg-gradient-glow rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          ...
          {isLoading && (
            <div className="flex items-center space-x-2 p-4 bg-chat-assistant rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="relative flex items-end space-x-2">
            ...
            <Button
              ...
              className="h-11 w-11 p-0 bg-gradient-primary hover:opacity-90 shadow-glow"
            >
